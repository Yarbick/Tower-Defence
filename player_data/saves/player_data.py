...
def get_available_levels() -> None:
    ...
    with open("player_data/saves/available_levels.csv", mode="r", encoding="UTF-8") as file:
        ...
        levels = {level_name: LEVEL_PROTOTYPES[level_name] for level_name in LEVEL_PROTOTYPES.keys() if available_levels[level_name] == "1"}
...
def get_available_towers() -> None:
    ...
    with open("player_data/saves/available_towers.csv", mode="r", encoding="UTF-8") as file:
        ...
        towers = {tower_name: TOWER_PROTOTYPES[tower_name] for tower_name in TOWER_PROTOTYPES.keys() if available_towers[tower_name] == "1"}
